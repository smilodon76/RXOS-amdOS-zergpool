...
If you have graphics cards with 2gb vram put ethash, etchash, kawpow to 0 because these cards can not extract them. If you do not want to extract an algorithm put 0.
